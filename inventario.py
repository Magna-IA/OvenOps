...
def calcular_inventario(piezas_actuales, cajas_actuales,
                        produccion_piezas=0, produccion_cajas=0,
                        merma_piezas=0, merma_cajas=0,
                        ventas_piezas=0, ventas_cajas=0):
...
def guardar_snapshot_diario(fecha,
                            piezas_anteriores,
                            cajas_anteriores,
                            produccion_piezas,
                            produccion_cajas,
...
def registrar_movimiento_inventario(fecha, produccion_piezas, produccion_cajas, merma_piezas=0, merma_cajas=0, ventas_piezas_hoy=0, ventas_cajas_hoy=0):
    """
